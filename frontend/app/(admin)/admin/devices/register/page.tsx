...
const schema = z.object({ serial_number: z.string().min(4), device_type: z.enum(["collar","tag","implant"]), firmware_version: z.string().optional() });
    ...
    <div className="max-w-md space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-6">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div><label className="block text-sm font-medium text-gray-700 mb-1.5">Type</label><select {...register("device_type")} className="input w-full"><option value="collar">Collar</option><option value="tag">Tag</option><option value="implant">Implant</option></select></div>
